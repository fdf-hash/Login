  ...
  <div class="zjb_home">
    ...
    <div class="zjb_con">
      ...
      <div class="zjb_header">
        ...
        <div class="zjb_banner">
          ...
          <van-swipe :autoplay="3000">
            ...
            <van-swipe-item><img
              src="https://msmk2019.oss-cn-shanghai.aliyuncs.com/uploads/image/20197Cxc53hktC1569839552.jpg" alt="">
            </van-swipe-item>
            <van-swipe-item><img
              src="https://msmk2019.oss-cn-shanghai.aliyuncs.com/uploads/image/2019MGNW3BtiS91569839576.jpg" alt="">
            </van-swipe-item>
            <van-swipe-item><img
              src="https://msmk2019.oss-cn-shanghai.aliyuncs.com/uploads/image/2019LnKumseuhw1569839569.jpg" alt="">
            </van-swipe-item>
            <van-swipe-item><img
              src="https://msmk2019.oss-cn-shanghai.aliyuncs.com/uploads/image/2019LnKumseuhw1569839569.jpg" alt="">
            </van-swipe-item>
      ...
      <div id="zjb_con_recommend">
        <p>推荐课程</p>
        <ul>
          <li v-for="(item,key) in Recommend[0].list" :key="key" @click="pushDetails(item)">
            <h1>{{item.title}}</h1>
            <h2>
              <p>
            ...
            <h4>
              ...
              <p :style="item.price=='免费'?'':'color: #ee1f1f;'">
                {{item.price}}
              </p>
            </h4>
          </li>
      ...
      <div id="zjb_con_Boutique">
        <p>会员课程推荐</p>
        <ul>
          <li v-for="(item,key) in Recommend[1].list" :key="key" @click="pushDetails(item)">
            <h1>{{item.title}}</h1>
            <h2>
              <p>
                10月23日13:00〜10月23日14:45&nbsp;&nbsp;|&nbsp;&nbsp;
      ...
      <div class="zjb_con_home">
        ...
        <p>讲师推荐</p>
        <ul>
          <li v-for="(item,key) in Recommend[2].list" :key="key" @click="pushTearch(item.teacher_id)">
            <img :src="item.teacher_avatar" alt="">
            <div class="zjb_right">
              <div>
        ...
        <p>约课讲师</p>
        <ul>
          <li v-for="(item,key) in Recommend[3].list" :key="key" @click="pushTearch(item.teacher_id)">
            <img :src="item.teacher_avatar" alt="">
            <div class="zjb_right">
              <div>
                <p>{{item.teacher_name}}</p>
...
<style scoped lang="scss">
  ...
  #zjb_con_recommend, #zjb_con_Boutique {
    width: 6rem;
    margin: 0 auto;
